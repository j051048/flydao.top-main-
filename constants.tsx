import { Film, Gamepad2, Newspaper, Home, Cpu, BookOpen, Camera } from 'lucide-react';
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: SectionType.LITERATURE, icon: BookOpen },
  { id: SectionType.PHOTOGRAPHY, icon: Camera },
