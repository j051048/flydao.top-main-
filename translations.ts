export const translations = {
  en: {
    nav: {
      ...
      game: 'AI Gaming',
      news: 'Research',
      literature: 'AI Literature',
      photography: 'AI Photo',
      app: 'AI Apps',
      connect: 'Connect Wallet',
    },
    hero: {
      status: 'System Online v2.1.0',
    ...
    sections: {
      ...
      literature_title: 'AI Literature',
      literature_desc: 'Co-create novels and scripts with large language models. A decentralized library for human-AI collaborative fiction.',
      literature_badge: 'Storytelling',
      photography_title: 'AI Photography',
      photography_desc: 'Generate photorealistic imagery and digital art. Mint your masterpieces as NFTs directly to the ecosystem.',
      photography_badge: 'Visual Arts',
      app_title: 'AI Apps',
  ...
  zh: {
    ...
    sections: {
      ...
      news_badge: '情报资讯',
      literature_title: 'AI 文学',
      literature_desc: '与大语言模型共创小说与剧本。一个去中心化的人机协作小说图书馆。',
      literature_badge: '文学创作',
      photography_title: 'AI 摄影',
      photography_desc: '生成逼真的摄影级图像与数字艺术。将您的杰作直接铸造为生态 NFT。',
      photography_badge: '视觉艺术',
      app_title: 'AI 应用',
