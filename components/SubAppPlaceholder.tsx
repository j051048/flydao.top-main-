...
import { ExternalLink, ArrowLeft, CloudSun, Shirt, Camera, Sparkles, BookOpen, Gamepad2, Coins, Lock, Box, Mountain, Sprout, TrendingUp, Stethoscope, ShoppingBag, Zap, Heart } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto w-full">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              >
               ...
               {/* APP CARD 6: AI Plant Doctor (Paid) */}
              <div 
                onClick={() => handleGameClick(
                  language === 'zh' ? 'AI植物医生' : 'AI Plant Doctor',
              ...
              >
                 ...
                 <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 flex items-center justify-center">
                    ...
                    {/* Stylized Sprout Icon */}
                    <div className="relative z-10 transform group-hover:scale-110 transition-transform duration-500">
                        <div className="absolute inset-0 bg-green-500 blur-2xl opacity-40"></div>
                        <Sprout className="w-24 h-24 text-green-300 drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)]" strokeWidth={1.5} />
                    </div>

                    {/* Lock Icon Overlay indicating payment required */}
                    <div className="absolute -top-2 -right-2 w-10 h-10 bg-black/50 rounded-full flex items-center justify-center backdrop-blur border border-white/20 z-20 group-hover:bg-green-500 transition-colors">
                        <Lock className="w-5 h-5 text-white" />
                    </div>
                 ...
                 <div className="absolute bottom-0 w-full p-6 bg-gradient-to-t from-black/80 to-transparent pt-20">
                    ...
                    <div className="flex items-center gap-2 text-xs text-green-300 font-mono">
                      ...
                      Web3 App
                      <span className="text-green-400 font-bold ml-2">1,000 FLY</span>
                    </div>
                 </div>
              </div>
              ...
              {/* APP CARD 8: AI Tongue Diagnosis (Paid) */}
              <div 
                onClick={() => handleGameClick(
                  language === 'zh' ? 'AI中医看舌' : 'AI Tongue Diagnosis',
              ...
              >
                 ...
                 <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 flex items-center justify-center">
                    ...
                    {/* Stylized Icon */}
                    <div className="relative z-10 transform group-hover:scale-110 transition-transform duration-500">
                        <div className="absolute inset-0 bg-red-500 blur-2xl opacity-40"></div>
                        <Stethoscope className="w-24 h-24 text-red-300 drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)]" strokeWidth={1.5} />
                    </div>

                    {/* Lock Icon Overlay indicating payment required */}
                    <div className="absolute -top-2 -right-2 w-10 h-10 bg-black/50 rounded-full flex items-center justify-center backdrop-blur border border-white/20 z-20 group-hover:bg-red-500 transition-colors">
                        <Lock className="w-5 h-5 text-white" />
                    </div>
                 ...
                 <div className="absolute bottom-0 w-full p-6 bg-gradient-to-t from-black/80 to-transparent pt-20">
                    ...
                    <div className="flex items-center gap-2 text-xs text-red-300 font-mono">
                      ...
                      Web3 App
                      <span className="text-red-400 font-bold ml-2">1,000 FLY</span>
                    </div>
                 </div>
              </div>

              {/* APP CARD 9: AI E-commerce Product Image Gen (Paid) */}
              <div 
                onClick={() => handleGameClick(
                  language === 'zh' ? 'AI电商产品生图神器' : 'AI Product Image Gen',
              ...
              >
                 ...
                 <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 flex items-center justify-center">
                    ...
                    <div className="relative z-10 transform group-hover:scale-110 transition-transform duration-500">
                        ...
                        <ShoppingBag className="w-24 h-24 text-blue-300 drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)]" strokeWidth={1.5} />
                    </div>

                    {/* Lock Icon Overlay indicating payment required */}
                    <div className="absolute -top-2 -right-2 w-10 h-10 bg-black/50 rounded-full flex items-center justify-center backdrop-blur border border-white/20 z-20 group-hover:bg-blue-500 transition-colors">
                        <Lock className="w-5 h-5 text-white" />
                    </div>
              ...
              >
               ...
               {/* APP CARD 11: AI Destiny Calculator (Free) */}
              <a 
              ...
              >
                 ...
                 <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 flex items-center justify-center">
                    ...
                    <div className="relative z-10 transform group-hover:scale-110 transition-transform duration-500">
                        <div className="absolute inset-0 bg-pink-500 blur-2xl opacity-40"></div>
                        <Heart className="w-24 h-24 text-pink-300 drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)]" strokeWidth={1.5} />
                    </div>

                    {/* Decorative Sparkles */}
                    <div className="absolute top-6 right-6 w-2 h-2 bg-white rounded-full animate-pulse"></div>
                    <Sparkles className="absolute bottom-6 left-6 w-6 h-6 text-pink-200 animate-bounce delay-75" />
                 </div>

                 {/* Text Info */}
                 <div className="absolute bottom-0 w-full p-6 bg-gradient-to-t from-black/80 to-transparent pt-20">
                    <h3 className="text-xl font-bold text-white mb-1">
                      {language === 'zh' ? 'AI缘算师' : 'AI Destiny Calculator'}
                    </h3>
